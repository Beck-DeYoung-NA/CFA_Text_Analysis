cdata<-read.csv("U:/computer/Python BERT/CFA data/outQ5top13_3_reformatted.csv") #using larger validation set
dim(cdata)
...
ddata<-cdata[true_4==1,]
all_acodes4<-c(ddata$acode1,ddata$acode2,ddata$acode3,ddata$acode4,ddata$acode5,ddata$acode6,ddata$acode7,ddata$acode8,ddata$acode9,ddata$acode10)
sort(table(all_acodes4))
length(unique(all_acodes4))
table(all_acodes4)
# all_acodes4
# 7  70   8   6  12  13   2  52  53  54   4 
# 1   2   4   5   7   9  10  11  11  11 102 

ddata<-cdata[true_12==1,]
all_acodes12<-c(ddata$acode1,ddata$acode2,ddata$acode3,ddata$acode4,ddata$acode5,ddata$acode6,ddata$acode7,ddata$acode8,ddata$acode9,ddata$acode10)
sort(table(all_acodes12))
length(unique(all_acodes12))
table(all_acodes12)
# all_acodes12
# 6   7   2  53  69   4  54  70  52  13   3   8  12 
# 2   4   6   6   6   7   9   9  10  13  14  15 101
...
# all_pcodes  These are the latest version
# 2   3   6   7  13  52  53  54  69  70 
# 224 106  80  40 273 149 302 129  15 161 


############################# Stopped updating here ############################################
############ why is no one predicted in 4 or 12???????????? ####################################
